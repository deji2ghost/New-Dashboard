...
export const Home = ({ currentUser, setUserLoggedIn, userLoggedIn }) => {
  ...
  return (
    <div className='app dark:text-stone-100 flex h-[100%] gap-2'>
        {/* sideNav */}
        <div className={`dark:bg-black bg-stone-100 ${collapsed ? 'transform w-[23%]' : 'transform w-[7%]'} transition-all ease-in-out duration-300 p-2 flex flex-col gap-5 sticky h-screen top-0 drop-shadow-lg`}>
